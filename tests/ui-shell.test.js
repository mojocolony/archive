...
test('v0.2.6 ships the package-open app icon and install metadata', async () => {
  ...
  assert.match(appSource, /const VERSION = '0\.2\.6'/)
  ...
  assert.match(worker, /archive-shell-v0\.2\.6/)
