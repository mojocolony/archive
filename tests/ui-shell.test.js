...
test('v0.2.4 ships the package-open app icon and install metadata', async () => {
  ...
  assert.match(appSource, /const VERSION = '0\.2\.4'/)
  ...
  assert.match(worker, /archive-shell-v0\.2\.4/)
