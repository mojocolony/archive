...
test('v0.2.5 ships the package-open app icon and install metadata', async () => {
  ...
  assert.match(appSource, /const VERSION = '0\.2\.5'/)
  ...
  assert.match(worker, /archive-shell-v0\.2\.5/)
