...
test('v0.3.2 ships transcript rendering and the package-open install metadata', async () => {
  ...
  assert.match(appSource, /const VERSION = '0\.3\.2'/)
  ...
  assert.match(worker, /archive-shell-v0\.3\.2/)
